...
use webrender_traits::{WebrenderExternalImageRegistry, WebRenderNetApi, WebRenderScriptApi};
        ...
        thread::Builder::new()
            ...
            .spawn(move || {
                ...
                let mut constellation: Constellation<STF, SWF> = Constellation {
                    ...
                    webrender_api_ipc_sender: WebRenderScriptApi::new(
                        webrender_ipc_sender,
                    ),
                    webrender_image_api_sender: WebRenderNetApi::new(
